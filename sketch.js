var path,boy,cash,diamonds,jwellery,sword,boyStopImg;;
...
function preload(){
  ...
  boyStopImg=loadAnimation("Runner-1.png");
...
boy.addAnimation("SahilStopped",boyStopImg);
boy.scale=0.08;

//gameOver Msg
over = createSprite(200,50,20,20);
...
function draw() {
  ...
  if(path.y > 400 ){
    ...
    if (cashG.isTouching(boy)) {
      ...
      gameState=END;
      boy.changeAnimation("stopped", boyStopImg);
      boy.x=200;
      boy.y=500;
